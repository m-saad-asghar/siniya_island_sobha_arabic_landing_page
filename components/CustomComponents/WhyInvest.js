...
export default function WhyInvest() {
    return (
        <>
            <section className="custom_container" id="why-choose-siniya" dir="rtl">
...
والمساحات الخضراء الواسعة، والمساكن الفاخرة</p>
 مثالية للمستثمرين وأصحاب المنازل على حد سواء، وتوفر أسلوب حياة عالمي المستوى في موقع مزدهر ومرغوب فيه.<p>
        </p>
       ...
       <div className="row feature_row">
                ...
                <a href="javascript:void(0);">16 مليون قدم مربع</a></h2>
                <p className="investment_text">
                  <span className="about_para_span">تطوير متعدد الاستخدامات</span>
                </p> 
                                            </div>
                                        </div>
                                    </div>
                ...
                <p className="investment_text">
                  <span className="about_para_span"> فاخرة قادمة</span>
                </p> 
                                            </div>
                                        </div>
                                    </div>
                ...
                <p className="investment_text">
                  <span className="about_para_span">مساحات خضراء مفتوحة</span>
                </p>
...
{/* <Umbrella className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    <h2 className="amenities_styling">العيش الحصري في الجزيرة</h2>
                                    <div>اكتشف أسلوب حياة الجزيرة فريد من نوعه مع مساكن فاخرة ومرافق استثنائية عالمية المستوى.</div>
                                </div>
                            </div>
                        </div>
...
{/* <TreePine className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    ...
                                    <p>تخصص جزيرة شوبا السينية نحو 46٪ من مساحتها للحدائق المورقة والمساحات الطبيعية الهادئة، لتوفير بيئة تجمع بين الهدوء والحيوية لسكانها.</p>
                                </div>
                            </div>
                        </div>
                         <div className="shadow_line">
...
{/* <Sailboat className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    <h2 className="amenities_styling">مرافق عالمية المستوى</h2>
                                    <p>استمتع بالمنتجعات، والمراسي، ومساحات الترفيه المصممة لأسلوب حياة عصري مستوحى من المنتجعات.</p>
                                </div>
                            </div>
                        </div>
                         <div className="shadow_line">
...
{/* <MapPin className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    <h2 className="amenities_styling">موقع متميز</h2>
                                    <p>مرتبط بشكل مثالي بدبي ورأس الخيمة، مما يوفر وصولاً سهلاً إلى أهم المعالم والمراكز الرئيسية.</p>
                                </div>
                            </div>
                        </div>
                         <div className="shadow_line">
...
{/* <Leaf className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    <h2 className="amenities_styling">تطوير مستدام</h2>
                                    <p>مخطط بعناية مع تصميم صديق للبيئة، ومساحات مفتوحة، وتنمية مسؤولة لمستقبل أكثر خضرة.</p>
                                </div>
                            </div>
                        </div>
                         <div className="shadow_line">
...
{/* <TrendingUp className="text-gray-100" style={{ fontWeight: 100 }} size={40}/>  */}
                                ...
                                <div className="content-box">
                                    ...
                                    <p>توفر جزيرة شوبا السينية قيمة قوية طويلة الأمد، مع عائد استثماري قوي للمستثمرين المميزين.</p>
                                </div>
                            </div>
                        </div>
                         <div className="shadow_line">
